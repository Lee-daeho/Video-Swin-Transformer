...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.3), test_cfg=dict(max_testing_views=4, average_clips='prob'), cls_head=dict(num_classes=51, spatial_type='avg'),)
